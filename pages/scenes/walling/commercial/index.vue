<template>
  <div class="scenes scenes-inside d_flex flex_column mh_100">
    <main class="main flex_1 d_flex flex_column">
      <nav class="breadcrumbs">
        <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="d_flex align-items_center justify-content_center">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <NuxtLink to="../" itemprop="item">
              <span itemprop="name" class="fs_42 fw_semibold">Walling</span>
            </NuxtLink>
            <meta itemprop="position" content="2" />
            <span class="ff_icon fs_r32"></span>
          </li>
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <span itemprop="name" class="fs_42 fw_semibold">Commercial</span>
      ...
      <section class="scenes-examples flex_1 d_flex align-items_center ">
        <div class="container container_mw">
          <div class="row align-items_center justify-content_center">
            <div class="col col-lg-4 col-md-6 col-sm-12" v-for="(item,idx) in scenes" v-bind:key="idx">
              <div :to="item.url" class="card scenes__card d_block">
...
<script setup>
  const pageTitle = 'Walling Commercial | BLOC-TEC',
        baseUrl = 'https://bloc-tec.com',
        pageDescription = 'Try out Bloc-Tec’s Interactive Visualisation software and see how your building materials will look on the wall of different commercial buildings. Make adjustment to the layout and color of the materials and see if they match well with different buildings of different colors and designs.',
        pageKeywords = 'walling,wall,offices,shop,factory,hospital,school,mall,commercial,scene,building,location,visualisation,visualization,software,program,online,website,view,try,demo,samples,options,selection,realistic',
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:url', content: baseUrl+'/scenes/walling/commercial/' },
      ...
      { property: 'linkedin:url', content: baseUrl+'/scenes/walling/commercial/' },
  ...
  const route = 'scenes/walling/commercial/'
  const scenes = [
    {
      img: route+'commercial1',
      title: 'Commercial Wall 1',
      url: '#'
    },
    {
