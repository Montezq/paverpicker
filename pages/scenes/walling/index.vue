...
<script setup>
  const pageTitle = 'Walling | BLOC-TEC',
        ...
        pageDescription = 'Try out Bloc-Tec’s Interactive Visualisation software and see how your building materials will look on the wall of different places. Make adjustment to the layout and color of the materials and see if they match well with different buildings of different colors and designs.',
        pageKeywords = 'walling,wall,garden,backyard,frontyard,grass area,play area,rooms,house,commercial,scene,home,building,location,visualisation,visualization,software,program,online,website,view,try,demo,samples,options,selection,realistic,house',
