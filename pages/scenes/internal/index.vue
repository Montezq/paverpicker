...
<script setup>
  const pageTitle = 'Internal | BLOC-TEC',
        baseUrl = 'https://bloc-tec.com',
        pageDescription = 'Try out Bloc-Tec’s Interactive Visualisation software and see how your building materials will look on the wall and floor in different places of a home or building. Make adjustment to the layout and color of the materials and see if they match well with different buildings of different colors and designs.',
        pageKeywords = 'internal,inside,rooms,room,living room,kitchen,dining room,bed room,washroom,toilet,office,wall,walling,flooring,floor,tile,walking,driveway,patio,commercial,scene,home,building,location,visualisation,visualization,software,program,online,website,view,try,demo,samples,options,selection,realistic,house',
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:url', content: baseUrl+'/scenes/internal/' },
      ...
      { property: 'linkedin:url', content: baseUrl+'/scenes/internal/' },
