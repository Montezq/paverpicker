...
<script setup>
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:url', content: baseUrl+'/scenes/internal/flooring/' },
      ...
      { property: 'linkedin:url', content: baseUrl+'/scenes/internal/flooring/' },
  ...
  const route = 'scenes/internal/flooring/'
  const scenes = [
    {
      img: route+'floor1',
