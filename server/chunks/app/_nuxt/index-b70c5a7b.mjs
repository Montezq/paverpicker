...
const pageTitle = "Walling Commercial | BLOC-TEC", baseUrl = "https://bloc-tec.com", pageDescription = "Try out Bloc-Tec\u2019s Interactive Visualisation software and see how your building materials will look on the wall of different commercial buildings. Make adjustment to the layout and color of the materials and see if they match well with different buildings of different colors and designs.", pageKeywords = "walling,wall,offices,shop,factory,hospital,school,mall,commercial,scene,building,location,visualisation,visualization,software,program,online,website,view,try,demo,samples,options,selection,realistic", imageAlt = "Alternative text for the image", imageName = "software";
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/scenes/walling/commercial/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-b70c5a7b.mjs.map
