...
const pageTitle = "Walling Garden | BLOC-TEC", baseUrl = "https://bloc-tec.com", pageDescription = "Try out Bloc-Tec\u2019s Interactive Visualisation software and see how your building materials will look on the wall in the garden area. Make adjustment to the layout and color of the materials and see if they match well with different buildings of different colors and designs.", pageKeywords = "walling,wall,garden,backyard,frontyard,grass area,play area,green house,house,scene,home,location,visualisation,visualization,software,program,online,website,view,try,demo,samples,options,selection,realistic,house", imageAlt = "Alternative text for the image", imageName = "software";
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/scenes/walling/garden/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-946286c2.mjs.map
