...
const pageTitle = "Paving Patios | BLOC-TEC", baseUrl = "https://bloc-tec.com", pageDescription = "Try out Bloc-Tec\u2019s Interactive Visualisation software and see how your paving materials will look for the patio. Make adjustment to the layout and color of the materials and see if they match well with different buildings of different colors and designs.", pageKeywords = "paving,patio,backyard,garden,scene,home,building,location,visualisation,visualization,software,program,online,website,view,try,demo,samples,options,selection,realistic,house", imageAlt = "Alternative text for the image", imageName = "software";
const route = "scenes/paving/patios/";
const _sfc_main = {
  __name: "index",
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        ...
        { property: "og:url", content: baseUrl + "/scenes/paving/patios/" },
        ...
        { property: "linkedin:url", content: baseUrl + "/scenes/paving/patios/" },
        // Instagram meta tags
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/scenes/paving/patios/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-cd055fcd.mjs.map
