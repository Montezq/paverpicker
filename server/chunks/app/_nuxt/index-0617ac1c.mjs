...
const pageTitle = "Roofing | BLOC-TEC", baseUrl = "https://bloc-tec.com", pageDescription = "Try out Bloc-Tec\u2019s Interactive Visualisation software and see how your roof building materials will look on homes. Make adjustments to the layout and color of the materials and see if they match well with homes of different colors and designs.", pageKeywords = "roof,roofing,house,roof tiles,building,home,shed,shingles,asphalt,composition,metal,concrete,metal,aluminum shake,wood,clay,vinyl membrane,flat roof,cover,material,rain", imageAlt = "Alternative text for the image", imageName = "software";
const route = "scenes/roofing/";
const _sfc_main = {
  __name: "index",
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        ...
        { property: "og:url", content: baseUrl + "/scenes/roofing/" },
        ...
        { property: "linkedin:url", content: baseUrl + "/scenes/roofing/" },
        // Instagram meta tags
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/scenes/roofing/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-0617ac1c.mjs.map
